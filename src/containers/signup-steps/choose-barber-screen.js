                    ...
                    {barberTeam.map((barber) => {
                        ...
                        return(
                            <div>
                                ...
                                <label htmlFor={barber.name} key={barber.name} className={'peer-checked:bg-[#D58258] peer-checked:text-white cursor-pointer hover:bg-black bg-white hover:text-white grid grid-cols-2 text-left w-[40rem] border rounded-xl p-8 px-6 my-4 text-xl transition ease-in-out duration-150'}>
                                    <div>
                                        {barber.name}
                                    </div>
